...
func TestUp1(t *testing.T) {
	...
	expected, err := convertMapToJsonString(map[string]interface{}{
		...
		"force":           false,
		"str______":       "",
		"str_______":      "Str comment",
		"str":             "str",
		"number______":    "",
		"number_______":   "Number comment",
		"number________":  "Number comment1",
		"number_________": "Number comment1",
		"number":          1,
		"boolean______":   "",
		"boolean_______":  "Boolean comment",
		"boolean":         true,
	})
	if err != nil {
		t.Error(err)
...
func TestUp2(t *testing.T) {
	...
	expected, err := convertMapToJsonString(map[string]interface{}{
		...
		"map": map[string]interface{}{
			"map_str______": "map_str______ STR",
			"map_str":       "map_str",
			"map_number":    2,
			"map_boolean":   false,
		},
...
func TestUp3(t *testing.T) {
	...
	expected, err := convertMapToJsonString(map[string]interface{}{
		...
		"array": []map[string]interface{}{
			...
			{
				"map_array_boolean______":  "",
				"map_array_boolean_______": "Some comments",
				"map_array_boolean":        []bool{false, true, false},
				"map_array_number":         []int{4, 5, 6},
				"map_array_str______":      "Some comments",
				"map_array_str":            []string{"str4", "str5", "str6"},
				"map_boolean______":        "Some comments",
				"map_boolean":              false,
				"map_number":               2,
				"map_str______":            "Some comments",
				"map_str":                  "map_str2",
			},
		},
		"array2":       []int{1, 2, 3},
		"array3":       []string{"str1", "str2", "str3"},
		"array4______": "Some comments",
...
func TestUp3_Comments(t *testing.T) {
	...
	expected, err := convertMapToJsonString(map[string]interface{}{
		...
		"array": []map[string]interface{}{
			...
			{
				"_________________map_array_boolean_": "Some comments",
				"map_array_boolean":                   []bool{false, true, false},
				"map_array_number":                    []int{4, 5, 6},
