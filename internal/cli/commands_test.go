...
func (s *CreateCmdSuite) TestCreateCmd() {
	...
	cases := []struct {
		...
		{"seq and format", nil, "", nil, nil, errIncompatibleSeqAndFormat, ".", ts, "unix", true, 4, "yaml", "name"},
		{"seq init dir dot", nil, "", nil, []string{"0001_name.up.yaml", "0001_name.down.yaml"}, nil, ".", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq init dir dot trailing slash", nil, "", nil, []string{"0001_name.up.yaml", "0001_name.down.yaml"}, nil, "./", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq init dir double dot", []string{"subdir"}, "subdir", nil, []string{"0001_name.up.yaml", "0001_name.down.yaml"}, nil, "..", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq init dir double dot trailing slash", []string{"subdir"}, "subdir", nil, []string{"0001_name.up.yaml", "0001_name.down.yaml"}, nil, "../", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq init dir absolute", []string{"subdir"}, "", nil, []string{"subdir/0001_name.up.yaml", "subdir/0001_name.down.yaml"}, nil, "/subdir", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq init dir absolute trailing slash", []string{"subdir"}, "", nil, []string{"subdir/0001_name.up.yaml", "subdir/0001_name.down.yaml"}, nil, "/subdir/", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq init dir relative", []string{"subdir"}, "", nil, []string{"subdir/0001_name.up.yaml", "subdir/0001_name.down.yaml"}, nil, "subdir", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq init dir relative trailing slash", []string{"subdir"}, "", nil, []string{"subdir/0001_name.up.yaml", "subdir/0001_name.down.yaml"}, nil, "subdir/", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq init dir dot relative", []string{"subdir"}, "", nil, []string{"subdir/0001_name.up.yaml", "subdir/0001_name.down.yaml"}, nil, "./subdir", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq init dir dot relative trailing slash", []string{"subdir"}, "", nil, []string{"subdir/0001_name.up.yaml", "subdir/0001_name.down.yaml"}, nil, "./subdir/", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq init dir double dot relative", []string{"subdir"}, "subdir", nil, []string{"subdir/0001_name.up.yaml", "subdir/0001_name.down.yaml"}, nil, "../subdir", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq init dir double dot relative trailing slash", []string{"subdir"}, "subdir", nil, []string{"subdir/0001_name.up.yaml", "subdir/0001_name.down.yaml"}, nil, "../subdir/", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq init dir maze", []string{"subdir"}, "subdir", nil, []string{"0001_name.up.yaml", "0001_name.down.yaml"}, nil, "..//subdir/./.././/subdir/..", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq width invalid", nil, "", nil, nil, errInvalidSequenceWidth, ".", ts, defaultTimeFormat, true, 0, "yaml", "name"},
		{"seq malformed", nil, "", []string{"bad.yaml"}, []string{"bad.yaml"}, errors.New("Malformed migration filename: bad.yaml"), ".", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq not int", nil, "", []string{"bad_bad.yaml"}, []string{"bad_bad.yaml"}, errors.New(`strconv.ParseUint: parsing "bad": invalid syntax`), ".", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq negative", nil, "", []string{"-5_negative.yaml"}, []string{"-5_negative.yaml"}, errors.New(`strconv.ParseUint: parsing "-5": invalid syntax`), ".", ts, defaultTimeFormat, true, 4, "yaml", "name"},
		{"seq increment", nil, "", []string{"3_three.yaml", "4_four.yaml"}, []string{"3_three.yaml", "4_four.yaml", "0005_five.up.yaml", "0005_five.down.yaml"}, nil, ".", ts, defaultTimeFormat, true, 4, "yaml", "five"},
		{"seq overflow", nil, "", []string{"9_nine.yaml"}, []string{"9_nine.yaml"}, errors.New(`Next sequence number 10 too large. At most 1 digits are allowed`), ".", ts, defaultTimeFormat, true, 1, "yaml", "ten"},
		{"time empty format", nil, "", nil, nil, errInvalidTimeFormat, ".", ts, "", false, 0, "yaml", "name"},
		{"time unix", nil, "", nil, []string{tsUnixStr + "_name.up.yaml", tsUnixStr + "_name.down.yaml"}, nil, ".", ts, "unix", false, 0, "yaml", "name"},
		{"time unixNano", nil, "", nil, []string{tsUnixNanoStr + "_name.up.yaml", tsUnixNanoStr + "_name.down.yaml"}, nil, ".", ts, "unixNano", false, 0, "yaml", "name"},
		{"time custom format", nil, "", nil, []string{"20001225000102_name.up.yaml", "20001225000102_name.down.yaml"}, nil, ".", ts, "20060102150405", false, 0, "yaml", "name"},
		{"time version collision", nil, "", []string{"20001225_name.up.yaml", "20001225_name.down.yaml"}, []string{"20001225_name.up.yaml", "20001225_name.down.yaml"}, errors.New("duplicate migration version: 20001225"), ".", ts, "20060102", false, 0, "yaml", "name"},
		{"dir invalid", nil, "", []string{"file"}, []string{"file"}, errors.New("mkdir 'test: this is invalid dir name'\x00: invalid argument"), "'test: this is invalid dir name'\000", ts, "unix", false, 0, "yaml", "name"},
	}
